...
import com.preritrajput.firestoreapp.databinding.ActivityEditExperimentBinding;
...
public class EditExperimentActivity extends AppCompatActivity {
    ...
    private ActivityEditExperimentBinding binding;
    ...
    String semesterNo,subj,courcode,fName,uid,email,timeStamp,expNo,aim,theory,code,outputPic,subTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityEditExperimentBinding.inflate(getLayoutInflater());
        ...
        courcode=getIntent().getStringExtra("courcode");
        ...
        outputPic=getIntent().getStringExtra("outputPic");
        subTime=getIntent().getStringExtra("subTime");

        binding.semesterNo.setText(expNo);
        binding.facultyName.setText(aim);
        binding.subjectName.setText(theory);
        ...
        try {
            Glide.with(getApplicationContext()).load(outputPic).placeholder(shimmerDrawable).into(binding.imageIv);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        binding.card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                bottomSheetDialog1=new BottomSheetDialog(EditExperimentActivity.this,R.style.BottomSheetTheme);
                View sheetview1= LayoutInflater.from(EditExperimentActivity.this).inflate(R.layout.bottom_camera,(ViewGroup) view.findViewById(R.id.bottom_sheet_camera_1));
        ...
        binding.relativeLayout2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(ExpNo) || TextUtils.isEmpty(Aim) || TextUtils.isEmpty(Theory) || TextUtils.isEmpty(OutputCode)) {
                    ...
                    Toast.makeText(EditExperimentActivity.this, "Please provide all details correctly", Toast.LENGTH_SHORT).show();
                }
                else
                {
                    ...
                    if(image_uri==null)
                    {
                        ...
                        hashMap.put("semester",semesterNo);
                        hashMap.put("uid",uid);
                        hashMap.put("email",email);
                        hashMap.put("facultyName",fName);
                        hashMap.put("subjectName",subj);
                        hashMap.put("courseCode",courcode);
                        hashMap.put("expNo",ExpNo);
                        hashMap.put("aim",Aim);
                        hashMap.put("theory",Theory);
                        hashMap.put("outputCode",OutputCode);
                        hashMap.put("subTime",subTime);
                        hashMap.put("outputPic",outputPic);
        ...
        binding.addAnother.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                EditExperimentActivity.super.onBackPressed();
            }
        });
    }
    ...
    {
        boolean result= ContextCompat.checkSelfPermission(EditExperimentActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
    ...
    {
        boolean result= ContextCompat.checkSelfPermission(EditExperimentActivity.this, Manifest.permission.CAMERA) == (PackageManager.PERMISSION_GRANTED);

        boolean result1= ContextCompat.checkSelfPermission(EditExperimentActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == (PackageManager.PERMISSION_GRANTED);
